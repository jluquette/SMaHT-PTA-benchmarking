...
#SBATCH --mem=16G             
#SBATCH --account=park
#SBATCH -o logs/cnv_hiscanner_rdr-only_one-lambda_%j.out
#SBATCH -e logs/cnv_hiscanner_rdr-only_one-lambda_%j.err
...
HISCANNER_DIR_BASE=${WORKING_DIR}/hiscanner_multisample-${multisample}_rdr-only
